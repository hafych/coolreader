/***************************************************************************
 *   CoolReader GUI                                                        *
 *   Copyright (C) 2011,2012 Konstantin Potapov <pkbo@users.sourceforge.net>
...
int InitDoc(const char *exename, char *fileName)
{
    ...
    fontDirs.add(Utf8ToUnicode(lString8(USERFONTDIR)));
    fontDirs.add(Utf8ToUnicode(lString8(SYSTEMFONTDIR)));
    CRLog::info("INIT...");
