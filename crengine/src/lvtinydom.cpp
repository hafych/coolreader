...
: _sectorSize( CACHE_FILE_SECTOR_SIZE ), _size(0), _indexChanged(false), _dirty(true), _domVersion(domVersion), _compType(compType), _cachePath(lString32::empty_str), _map(1024)
#if (USE_ZSTD == 1)
