...
- Parser selection, XML/HTML/text/bookmark format detection, cache-file
  serialization, draw mark collection and SVG decoding now use scoped RAII
  ownership instead of manual temporary-buffer cleanup.
