...
| Database schema 36 compatibility repair | fork-only | Repairs early downstream schema 34 databases and physically removes legacy OPDS secret columns | Retain while schemas 34–35 can still be upgraded |
