...
| User-managed SAF library roots | upstreamable | Remembers selected tree grants, exposes lost access, supports re-selection and removes roots without touching user files | Remove after upstream provides equivalent root lifecycle management |
