...
- [ ] Добавить полные fixture-базы для всех поддерживаемых границ схемы
  (`1`, `4`, `6`, `13`, `15`, `16`, `21`, `26`, `28`–`31`, `33`–`35`) и
  проверить весь upgrade, rollback при ошибке, повторный запуск и отказ от
  future schema; изолированные переходы `33`→`34` и `35`→`36` уже покрыты.
