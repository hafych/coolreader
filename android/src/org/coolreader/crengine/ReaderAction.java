...
public class ReaderAction {
	...
	private ReaderAction withIcon(int iconId) {
		return new ReaderAction(
				id, nameId, cmd, param, menuItemId,
				iconId, canRepeat, mayAssignOnTap);
	}

	private ReaderAction repeatable() {
		return new ReaderAction(
				id, nameId, cmd, param, menuItemId,
				iconId, true, mayAssignOnTap);
	}

	private ReaderAction notTapAssignable() {
		return new ReaderAction(
				id, nameId, cmd, param, menuItemId,
				iconId, canRepeat, false);
	}

	public boolean canRepeat() { return canRepeat; }
	public boolean mayAssignOnKey() { return true; }
	public boolean mayAssignOnTap() { return mayAssignOnTap; }
	public boolean activateWithLongMenuKey() { return false; }

	public ReaderAction(String id, int nameId, ReaderCommand cmd, int param) {
		this(id, nameId, cmd, param, 0);
	}

	public ReaderAction(String id, int nameId, ReaderCommand cmd, int param, int menuItemId) {
		this(id, nameId, cmd, param, menuItemId, 0, false, true);
	}
	...
	private ReaderAction(
		...
		this.mayAssignOnTap = mayAssignOnTap;
	}
	...
	public final static ReaderAction PAGE_DOWN = new ReaderAction("PAGE_DOWN", R.string.action_pagedown, ReaderCommand.DCMD_PAGEDOWN, 1 ).repeatable();
	public final static ReaderAction PAGE_DOWN_10 = new ReaderAction("PAGE_DOWN_10", R.string.action_pagedown_10, ReaderCommand.DCMD_PAGEDOWN, 10 ).repeatable();
	public final static ReaderAction PAGE_UP = new ReaderAction("PAGE_UP", R.string.action_pageup, ReaderCommand.DCMD_PAGEUP, 1 ).repeatable();
	public final static ReaderAction PAGE_UP_10 = new ReaderAction("PAGE_UP_10", R.string.action_pageup_10, ReaderCommand.DCMD_PAGEUP, 10 ).repeatable();
	...
	public final static ReaderAction BOOKMARKS = new ReaderAction("BOOKMARKS", R.string.action_bookmarks, ReaderCommand.DCMD_BOOKMARKS, 0, R.id.cr3_mi_bookmarks ).withIcon(R.drawable.cr3_button_bookmarks);
	...
	public final static ReaderAction ABOUT = new ReaderAction("ABOUT", R.string.dlg_about, ReaderCommand.DCMD_ABOUT, 0, R.id.cr3_mi_about ).withIcon(R.drawable.cr3_logo_button);
	...
	public final static ReaderAction TOC = new ReaderAction("TOC", R.string.action_toc, ReaderCommand.DCMD_TOC_DIALOG, 0, R.id.cr3_go_toc ).withIcon(R.drawable.cr3_viewer_toc);
	public final static ReaderAction SEARCH = new ReaderAction("SEARCH", R.string.action_search, ReaderCommand.DCMD_SEARCH, 0, R.id.cr3_mi_search ).withIcon(R.drawable.cr3_viewer_find);
	public final static ReaderAction GO_PAGE = new ReaderAction("GO_PAGE", R.string.action_go_page, ReaderCommand.DCMD_GO_PAGE_DIALOG, 0, R.id.cr3_mi_go_page ).withIcon(R.drawable.cr3_button_go_page);
	public final static ReaderAction GO_PERCENT = new ReaderAction("GO_PERCENT", R.string.action_go_percent, ReaderCommand.DCMD_GO_PERCENT_DIALOG, 0, R.id.cr3_mi_go_percent ).withIcon(R.drawable.cr3_button_go_percent);
	...
	public final static ReaderAction OPTIONS = new ReaderAction("OPTIONS", R.string.action_options, ReaderCommand.DCMD_OPTIONS_DIALOG, 0, R.id.cr3_mi_options ).withIcon(R.drawable.cr3_viewer_settings);
	...
	public final static ReaderAction TOGGLE_DAY_NIGHT = new ReaderAction("TOGGLE_DAY_NIGHT", R.string.action_toggle_day_night, ReaderCommand.DCMD_TOGGLE_DAY_NIGHT_MODE, 0, R.id.cr3_mi_toggle_day_night ).withIcon(R.drawable.cr3_option_night);
	public final static ReaderAction RECENT_BOOKS = new ReaderAction("RECENT_BOOKS", R.string.action_recent_books_list, ReaderCommand.DCMD_RECENT_BOOKS_LIST, R.id.book_recent_books ).withIcon(R.drawable.cr3_browser_folder_recent);
	public final static ReaderAction OPDS_CATALOGS = new ReaderAction("OPDS_CATALOGS", R.string.mi_book_opds_root, ReaderCommand.DCMD_OPDS_CATALOGS, 0).withIcon(R.drawable.cr3_browser_folder_opds);
	public final static ReaderAction FILE_BROWSER_ROOT = new ReaderAction("FILE_BROWSER_ROOT", R.string.mi_book_root, ReaderCommand.DCMD_FILE_BROWSER_ROOT, 0).withIcon(R.drawable.cr3_browser_folder_root);
	public final static ReaderAction FILE_BROWSER = new ReaderAction("FILE_BROWSER", R.string.action_file_browser, ReaderCommand.DCMD_FILE_BROWSER, 0, R.id.cr3_mi_open_file ).withIcon(R.drawable.cr3_browser_folder);
	public final static ReaderAction FILE_BROWSER_UP = new ReaderAction("FILE_BROWSER_UP", R.string.action_go_back, ReaderCommand.DCMD_FILE_BROWSER_UP, 0).withIcon(R.drawable.cr3_button_prev);
	public final static ReaderAction CURRENT_BOOK_DIRECTORY = new ReaderAction("DCMD_CURRENT_BOOK_DIRECTORY", R.string.mi_book_recent_goto, ReaderCommand.DCMD_CURRENT_BOOK_DIRECTORY, 0).withIcon(R.drawable.cr3_browser_folder_current_book);
	public final static ReaderAction CURRENT_BOOK = new ReaderAction("DCMD_CURRENT_BOOK", R.string.mi_book_back_to_reading, ReaderCommand.DCMD_CURRENT_BOOK, 0).withIcon(R.drawable.cr3_button_book_open);
	...
	public final static ReaderAction TOGGLE_TOUCH_SCREEN_LOCK = new ReaderAction("TOGGLE_TOUCH_SCREEN_LOCK", R.string.action_touch_screen_toggle_lock, ReaderCommand.DCMD_TOGGLE_TOUCH_SCREEN_LOCK, 0 ).notTapAssignable();
	...
	public final static ReaderAction TOGGLE_SELECTION_MODE = new ReaderAction("TOGGLE_SELECTION_MODE", R.string.action_toggle_selection_mode, ReaderCommand.DCMD_TOGGLE_SELECTION_MODE, 0, R.id.cr3_mi_select_text).withIcon(R.drawable.cr3_option_touch);
	...
	public final static ReaderAction GO_BACK = new ReaderAction("GO_BACK", R.string.action_go_back, ReaderCommand.DCMD_LINK_BACK, 0, R.id.cr3_go_back ).withIcon(R.drawable.cr3_button_prev);
	public final static ReaderAction GO_FORWARD = new ReaderAction("GO_FORWARD", R.string.action_go_forward, ReaderCommand.DCMD_LINK_FORWARD, 0, R.id.cr3_go_forward).withIcon(R.drawable.cr3_button_next);
	public final static ReaderAction TTS_PLAY = new ReaderAction("TTS_PLAY", R.string.mi_tts_play, ReaderCommand.DCMD_TTS_PLAY, 0, R.id.cr3_mi_tts_play ).withIcon(R.drawable.cr3_button_tts);
	public final static ReaderAction TTS_STOP = new ReaderAction("TTS_STOP", R.string.mi_tts_stop, ReaderCommand.DCMD_TTS_STOP, 0, R.id.cr3_mi_tts_stop ).withIcon(R.drawable.cr3_button_tts);
	...
	public final static ReaderAction OPEN_PREVIOUS_BOOK = new ReaderAction("OPEN_PREVIOUS_BOOK", R.string.action_open_last_book, ReaderCommand.DCMD_OPEN_PREVIOUS_BOOK, 0, R.id.cr3_go_previous_book).withIcon(R.drawable.cr3_btn_books_swap);
	public final static ReaderAction TOGGLE_AUTOSCROLL = new ReaderAction("TOGGLE_AUTOSCROLL", R.string.action_toggle_autoscroll, ReaderCommand.DCMD_TOGGLE_AUTOSCROLL, 0, R.id.cr3_mi_toggle_autoscroll).withIcon(R.drawable.cr3_button_scroll_go);
	...
	public final static ReaderAction SAVE_LOGCAT = new ReaderAction("SAVE_LOGCAT", R.string.action_logcat, ReaderCommand.DCMD_SAVE_LOGCAT, 0).withIcon(R.drawable.cr3_button_log);
	public final static ReaderAction EXIT = new ReaderAction("EXIT", R.string.action_exit, ReaderCommand.DCMD_EXIT, 0, R.id.cr3_mi_exit ).withIcon(R.drawable.cr3_viewer_exit);
	...
	public final static ReaderAction GDRIVE_SYNCTO = new ReaderAction("GDRIVE_SYNCTO", R.string.googledrive_sync_to, ReaderCommand.DCMD_GOOGLEDRIVE_SYNC, 0).withIcon(R.drawable.google_drive);
	public final static ReaderAction GDRIVE_SYNCFROM = new ReaderAction("GDRIVE_SYNCFROM", R.string.googledrive_sync_from, ReaderCommand.DCMD_GOOGLEDRIVE_SYNC, 1).withIcon(R.drawable.google_drive);
	 */

	private final static List<ReaderAction> ASSIGNABLE_ACTIONS;

	public static ReaderAction[] availableActions() {
		return availableActions(hasSystemBacklightDialog());
	}

	static ReaderAction[] availableActions(
			boolean includeSystemBacklightDialog) {
		int extra = includeSystemBacklightDialog ? 1 : 0;
		ReaderAction[] result = ASSIGNABLE_ACTIONS.toArray(
				new ReaderAction[ASSIGNABLE_ACTIONS.size() + extra]);
		if (includeSystemBacklightDialog)
			result[result.length - 1] = SHOW_SYSTEM_BACKLIGHT_DIALOG;
		return result;
	}
	...
	public static ReaderAction findById( String id ) {
		return findById(id, hasSystemBacklightDialog());
	}

	static ReaderAction findById(
			String id, boolean includeSystemBacklightDialog) {
		if ( id==null )
			return NONE;
		for (ReaderAction a : ASSIGNABLE_ACTIONS) {
			if ( id.equals(a.id) )
				return a;
		}
		if (includeSystemBacklightDialog
				&& SHOW_SYSTEM_BACKLIGHT_DIALOG.id.equals(id))
			return SHOW_SYSTEM_BACKLIGHT_DIALOG;
		if ( id.equals(REPEAT.id) )
			return REPEAT;
		return NONE;
	}
	public static ReaderAction findByMenuId( int id ) {
		return findByMenuId(id, hasSystemBacklightDialog());
	}

	static ReaderAction findByMenuId(
			int id, boolean includeSystemBacklightDialog) {
		if ( id==0 )
			return NONE;
		for (ReaderAction a : ASSIGNABLE_ACTIONS) {
			if ( id == a.menuItemId )
		...
		if (includeSystemBacklightDialog
				&& id == SHOW_SYSTEM_BACKLIGHT_DIALOG.menuItemId)
			return SHOW_SYSTEM_BACKLIGHT_DIALOG;
		return NONE;
	}

	private static boolean hasSystemBacklightDialog() {
		return DeviceInfo.EINK_HAVE_FRONTLIGHT
				&& DeviceInfo.EINK_ONYX
				&& DeviceInfo.ONYX_HAVE_BRIGHTNESS_SYSTEM_DIALOG;
	}
...
//				AUTOSCROLL_SPEED_DECREASE,
		 ...
		 */
		ASSIGNABLE_ACTIONS = Collections.unmodifiableList(
				new ArrayList<>(Arrays.asList(BASE_ACTIONS)));
	}
}
